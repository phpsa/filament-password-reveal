...
<div
        ...
        >
        @if ($isRevealable())
        <button type="button" class="flex hidden inset-y-0 right-0 justify-self-end items-center p-1 text-gray-400 hover:text-gray-700" @click="show = !show" :class="{'hidden': !show, 'block': show }">
            <!-- Heroicon name: eye -->
        ...
        <button type="button" class="flex hidden inset-y-0 right-0 items-center p-1 text-gray-400 hover:text-gray-700" @click="show = !show" :class="{'block': !show, 'hidden': show }">
